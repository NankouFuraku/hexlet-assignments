...
class ValidationTest {
    ...
    void testAdvancedValidate() {
        Address address = new Address("Origin", "First Winter", null, "1", "1");
        Map<String, List<String>> actual = Validator.advancedValidate(address);
        Map<String, List<String>> expected = Map.of("street", List.of("length less than 3", "can not be null"),
                "houseNumber", List.of("length less than 2"));
